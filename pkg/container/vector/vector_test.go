...
func TestCompareWithMinMax1(t *testing.T) {
	m := mpool.MustNewZero()
	v1 := NewVec(types.T_int32.ToType())
	defer v1.Free(m)
	v2 := NewVec(types.T_int32.ToType())
	defer v1.Free(m)
	result := NewVec(types.T_bool.ToType())
	defer result.Free(m)

	err := AppendFixedList(v1,
		[]int32{3, 7, 3, 7, 3, 7, 3, 7, 3, 7},
		nil, m)
	require.NoError(t, err)
	err = AppendFixedList(v2,
		[]int32{-1, 2, -1, 3, 2, 6, 7, 9, 8, 10},
		nil, m)
	require.NoError(t, err)

	err = CompareWithMinMax(v1, v2, result, 0 /*>*/, m)
	require.NoError(t, err)
	...
	require.True(t, GetFixedAt[bool](result, 4))
	require.True(t, GetFixedAt[bool](result, 5))
	require.False(t, GetFixedAt[bool](result, 6))
	require.False(t, GetFixedAt[bool](result, 7))
	require.False(t, GetFixedAt[bool](result, 8))
	require.False(t, GetFixedAt[bool](result, 9))

	result.Reset(*result.GetType())
	err = CompareWithMinMax(v1, v2, result, 1 /*<*/, m)
	require.NoError(t, err)
	...
	require.True(t, GetFixedAt[bool](result, 4))
	require.True(t, GetFixedAt[bool](result, 5))
	require.True(t, GetFixedAt[bool](result, 6))
	require.True(t, GetFixedAt[bool](result, 7))
	require.True(t, GetFixedAt[bool](result, 8))
	require.True(t, GetFixedAt[bool](result, 9))

	result.Reset(*result.GetType())
	err = CompareWithMinMax(v1, v2, result, 2 /*>=*/, m)
	require.NoError(t, err)
	require.True(t, GetFixedAt[bool](result, 0))
	require.True(t, GetFixedAt[bool](result, 1))
	require.True(t, GetFixedAt[bool](result, 2))
	...
	result.Reset(*result.GetType())
	err = CompareWithMinMax(v1, v2, result, 3 /*<=*/, m)
	require.NoError(t, err)
	require.False(t, GetFixedAt[bool](result, 0))
	require.False(t, GetFixedAt[bool](result, 1))
	require.True(t, GetFixedAt[bool](result, 2))
	...
	result.Reset(*result.GetType())
	err = CompareWithMinMax(v1, v2, result, 4 /*==*/, m)
	require.NoError(t, err)
	require.False(t, GetFixedAt[bool](result, 0))
	require.False(t, GetFixedAt[bool](result, 1))
	require.True(t, GetFixedAt[bool](result, 2))
...
func TestCompareWithMinMax2(t *testing.T) {
	m := mpool.MustNewZero()
